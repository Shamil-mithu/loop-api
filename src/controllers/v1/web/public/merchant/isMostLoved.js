  ...
  async function getMostLovedMerchantsV1Controller(req, res) {
    try {
      ...
      const merchants = await Merchant.aggregate([
        ...
        {
          $lookup: {
            from: "city", // Assuming the collection name for cities
            localField: "city_id",
            foreignField: "_id",
            as: "city"
          }
        ...
        {
          $lookup: {
            from: "country", // Assuming the collection name for countries
        ...
        {
          $lookup: {
            from: "state", // Assuming the collection name for states
            localField: "state_id",
            foreignField: "_id",
            as: "state"
          }
        ...
        {
          $lookup: {
            from: "area", // Assuming the collection name for areas
            localField: "area_id",
            foreignField: "_id",
            as: "area"
          }
        ...
        {
          $lookup: {
            from: "merchant_category", // Assuming the collection name for categories
...
/**
 * @swagger
 * /v1/web-app/merchant/loved/most:
 *   post:
 *     tags: [Web-Merchant]
